...
import { HoverAction } from '../actions/ActionItem'
...
export interface HoverOverlayBaseProps extends GenericHoverOverlayProps<HoverContext, HoverMerged, HoverAction> {}
